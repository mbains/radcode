...
CPPPATH_NODE = '/home/mbai/ppd/server/nodejs/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/home/mbai/ppd/server/nodejs/lib/node_modules'
LIBPATH_NODE = '/home/mbai/ppd/server/nodejs/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/mbai/ppd/server/nodejs/lib/node_modules'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/mbai/ppd/server/nodejs'
